...
$select= "SELECT * FROM desperdicio WHERE año = 2018";
...
<!-- partial -->
    ...
    <script type="text/javascript">
      ...
      google.charts.setOnLoadCallback(drawChart);
        ...
        var options = {
          chart: {
            title: 'Porcentaje de desperdicio mensual',
     ...
     <script>
  setTimeout("location.href='vaciohorno.php?tiempo=<?php echo $tiempo;?>'",<?php echo $tiempo*1000;?>);
</script>
