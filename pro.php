...
$select= "SELECT * FROM produccion WHERE año = 2018";
...
<!-- partial -->
                        ...
                        <div class="card">
                          <div class="card-body mb-4">
                            ...
                            <div class="text-center  border-md-0">
                                ...
                                <div class="text-center  border-md-0">
                                  <h2>Record de días sin accidentes</h2>
                                  <h1 class="text-dark font-weight-bold mb-md-3"><?php echo $record; ?></h1>
                                  <h4>Gracias por su compromiso</h4>
                                  <!-- <a href="accidentesController.php?op=2" class="btn btn-primary">Actualizar día de accidente</a> -->
                                </div>
    ...
    <!-- <script>
       setTimeout("location.href='calidad.php?tiempo=<?php echo $tiempo;?>'",<?php echo $tiempo*1000;?>);
    </script> -->
