...
$select= "SELECT * FROM consumogas WHERE año = 2018";
...
<!-- partial -->
    ...
    <script type="text/javascript">
      ...
      google.charts.setOnLoadCallback(drawChart);
        ...
        var options = {
          chart: {
            title: 'Consumo de gas natural (Kcal/kg)',
     ...
     <script>
  setTimeout("location.href='esmaltes.php?tiempo=<?php echo $tiempo;?>'",<?php echo $tiempo*1000;?>);
</script>
