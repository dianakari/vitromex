...
$select= "SELECT * FROM calidad WHERE año = 2018";
...
<!-- partial -->
    ...
    <script type="text/javascript">
      ...
      google.charts.setOnLoadCallback(drawChart);
        ...
        var options = {
          chart: {
            title: 'Porcentaje de calidad mensual(%)',
     ...
     <script>
  setTimeout("location.href='desperdicio.php?tiempo=<?php echo $tiempo;?>'",<?php echo $tiempo*1000;?>);
</script>
