...
$select= "SELECT * FROM consumoenergia WHERE año = 2018";
...
<!-- partial -->
    ...
    <script type="text/javascript">
      ...
      google.charts.setOnLoadCallback(drawChart);
        ...
        var options = {
          chart: {
            title: 'Consumo de energía eléctrica (Kw/m2)',
     ...
     <script>
  setTimeout("location.href='produccion.php?tiempo=<?php echo $tiempo;?>'",<?php echo $tiempo*1000;?>);
</script>
