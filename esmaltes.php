...
$select= "SELECT * FROM esmaltes WHERE año = 2018";
...
<!-- partial -->
    ...
    <script type="text/javascript">
      ...
      google.charts.setOnLoadCallback(drawChart);
        ...
        var options = {
          chart: {
            title: 'Desperdicio de esmaltes mensual por año %',
     ...
     <script>
  setTimeout("location.href='energia.php?tiempo=<?php echo $tiempo;?>'",<?php echo $tiempo*1000;?>);
</script>
